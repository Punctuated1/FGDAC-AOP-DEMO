...
public abstract class BenchMarkLogic implements BenchMarkLogicInterface {
	...
	protected long vlim=101000040;
	protected long[] totalDurationOpInsert = {0,0,0,0,0,0,0,0};
...
//		averageSize= totalSize/numberTestDataItems;
//		System.out.println("Total size: "+totalSize+" -- Avergae Row Size: "+averageSize);
		long numberRows = numberTestDataItems+BenchmarkConstants.BENCHMARK_GENERATE_MULTIPLIER;
		long totalDuration=0;
		int j=0;
		while(j<8) {
			totalDuration=totalDuration+totalDurationOpInsert[j];
			j++;
		}
		long averageDuration = totalDuration/numberRows;
		System.out.println("Number Inserts: "+numberRows+" -- total duration: "+totalDuration+" -- Avergae Duration: "+averageDuration);
