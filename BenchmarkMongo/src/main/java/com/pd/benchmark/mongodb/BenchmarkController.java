...
public class BenchmarkController {
	...
	public String doinserts1() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 1);
	...
	public String doinserts2() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 2);
		return insertResponse;
	}
	...
	public String doinserts3() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 3);
		return insertResponse;
	}
	...
	public String doinserts4() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 4);
		return insertResponse;
	}
	...
	public String doinserts5() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 5);
		return insertResponse;
	}
	...
	public String doinserts6() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 6);
		return insertResponse;
	}
	...
	public String doinserts7() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 7);
		return insertResponse;
	}
	...
	public String doinserts8() {
		...
		String insertResponse = this.benchmarkLogicTarget.doInserts(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 8);
		return insertResponse;
	}
	...
	public String readUpdate1() {
		...
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 1);
	...
	public String readUpdate2() {
		...
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 2);
		return readUpdateResponse;
	}
	@GetMapping("/readUpdate3")
	public String readUpdate3() {
		System.out.println("Enter readUpdate3 "+LocalDateTime.now());
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 3);
		return readUpdateResponse;
	}
	@GetMapping("/readUpdate4")
	public String readUpdate4() {
		System.out.println("Enter readUpdate4 "+LocalDateTime.now());
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 4);
		return readUpdateResponse;
	}
	@GetMapping("/readUpdate5")
	public String readUpdate5() {
		System.out.println("Enter readUpdate5 "+LocalDateTime.now());
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 5);
		return readUpdateResponse;
	}
	@GetMapping("/readUpdate6")
	public String readUpdate6() {
		System.out.println("Enter readUpdate6 "+LocalDateTime.now());
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 6);
		return readUpdateResponse;
	}
	@GetMapping("/readUpdate7")
	public String readUpdate7() {
		System.out.println("Enter readUpdate7 "+LocalDateTime.now());
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 7);
		return readUpdateResponse;
	}
	@GetMapping("/readUpdate8")
	public String readUpdate8() {
		System.out.println("Enter readUpdate8 "+LocalDateTime.now());
		String readUpdateResponse = this.benchmarkLogicTarget.doReadUpdate(BenchmarkConstants.BENCHMARK_TARGET_MONGO, 8);
		return readUpdateResponse;
	}
